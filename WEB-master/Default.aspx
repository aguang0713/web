...
<body>
    ...
    <div>
        ...
        姓名:<asp:TextBox ID="TextBox1" runat="server" Width="177px"></asp:TextBox>
        ...
        <br />
        電話:<asp:TextBox ID="TextBox2" runat="server" Width="175px"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox2" ErrorMessage="請輸入電話" ForeColor="Red" InitialValue="1234"></asp:RequiredFieldValidator>
&nbsp;&nbsp;&nbsp;
        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBox2" ErrorMessage="請輸入正確格式" ForeColor="Red" ValidationExpression="[0-9]*"></asp:RegularExpressionValidator>
        <br />
        Email:<asp:TextBox ID="TextBox5" runat="server"></asp:TextBox>
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox5" ErrorMessage="請輸入EMAIL" ForeColor="Red"></asp:RequiredFieldValidator>
&nbsp;&nbsp;
        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="TextBox5" ErrorMessage="請輸入正確格式" ForeColor="Red" ValidationExpression="[a-zA-Z0-9_]+@[a-zA-Z0-9._]+"></asp:RegularExpressionValidator>
        <br />
        <br />
        <br />
        優惠卷號碼:<asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
        <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="TextBox3" ControlToValidate="TextBox4" ErrorMessage="再確認一次" ForeColor="Red"></asp:CompareValidator>
        <br />
        再輸入一次<asp:TextBox ID="TextBox4" runat="server"></asp:TextBox>
        <br />
